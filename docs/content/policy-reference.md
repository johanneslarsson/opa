...
| <span class="opa-keep-it-together">``output := crypto.md5(string)``</span> | ``output`` is ``string`` md5 hashed and hex encoded. |
| <span class="opa-keep-it-together">``output := crypto.md5_base64url_encode(string)``</span> | ``output`` is ``string`` md5 hashed and base64 url encoded. |
| <span class="opa-keep-it-together">``output := crypto.sha1(string)``</span> | ``output`` is ``string`` sha1 hashed and hex encoded. |
| <span class="opa-keep-it-together">``output := crypto.sha1_base64url_encode(string)``</span> | ``output`` is ``string`` sha1 hashed and base64 url encoded. |
| <span class="opa-keep-it-together">``output := crypto.sha256(string)``</span> | ``output`` is ``string`` sha256 hashed and hex encoded. |
| <span class="opa-keep-it-together">``output := crypto.sha256_base64url_encode(string)``</span> | ``output`` is ``string`` sha256 hashed and base64 url encoded. |
